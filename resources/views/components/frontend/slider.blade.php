            ...
            <div class="card text-center shadow h-100 border-0">
                <div class="card-body">
                  <div class="service-card" style="text-align: center;width: 350px;border-radius: 22px;overflow: hidden;box-shadow: 0 6px 32px #bc9a6920, 0 1.5px 8px #0001;background: #fff;display: flex;flex-direction: column;align-items: center;transition: box-shadow 0.3s, transform 0.3s;opacity: 0;transform: translateY(40px);animation: cardFadeIn 0.8s cubic-bezier(.4,1.6,.6,1) 0.2s forwards;">
                    ...
                    <div style="padding: 20px 20px 6px 20px;width: 100%;text-align: center;font-size: 1.3rem;font-weight: bold;color: #222;font-family: 'Lama Sans', sans-serif !important;font-style: {{ app()->getLocale() == 'ar' ? 'italic' : 'normal' }};letter-spacing: 0.5px;">
                {{ __('messagess.hospitality_branch') }}
                    </div>
                    <div style=";padding: 0 20px 12px 20px; width: 100%; text-align: right; font-size: 1.05rem; color: #7a6c5c; font-family: 'Lama Sans', sans-serif !important;font-style: {{ app()->getLocale() == 'ar' ? 'italic' : 'normal' }};">
                {{ __('messagess.branch_hospitality_description') }}
                    </div>
            ...
            <div class="card text-center shadow h-100 border-0">
                <div class="card-body">
                    <div class="service-card" style="text-align: center;width: 350px;border-radius: 22px;overflow: hidden;box-shadow: 0 6px 32px #bc9a6920, 0 1.5px 8px #0001;background: #fff;display: flex;flex-direction: column;align-items: center;transition: box-shadow 0.3s, transform 0.3s;opacity: 0;transform: translateY(40px);animation: cardFadeIn 0.8s cubic-bezier(.4,1.6,.6,1) 0.2s forwards;">
                        ...
                        <div style="padding: 0 20px 12px 20px; width: 100%; text-align: right; font-size: 1.05rem; color: #7a6c5c; font-family: 'Lama Sans', sans-serif !important;font-style: {{ app()->getLocale() == 'ar' ? 'italic' : 'normal' }};">
                        {{ __('messagess.branch_tamkeen_description') }}
                        </div>
            ...
            <div class="card text-center shadow h-100 border-0"> 
                <div class="card-body">
                  <div class="service-card" style="text-align: center;width: 350px;border-radius: 22px;overflow: hidden;box-shadow: 0 6px 32px #bc9a6920, 0 1.5px 8px #0001;background: #fff;display: flex;flex-direction: column;align-items: center;transition: box-shadow 0.3s, transform 0.3s;opacity: 0;transform: translateY(40px);animation: cardFadeIn 0.8s cubic-bezier(.4,1.6,.6,1) 0.2s forwards;">
                    ...
                    <div style="padding: 0 20px 12px 20px; width: 100%; text-align: right; font-size: 1.05rem; color: #7a6c5c; font-family: 'Lama Sans', sans-serif !important;font-style: {{ app()->getLocale() == 'ar' ? 'italic' : 'normal' }};">
                        {{ __('messagess.home_services_description') }}
                    </div>
