                ...
                <button type="button" class="btn btn-secondary" data-modal="export">
                 ...
                 <?php $__env->slot('toolbar', null, []); ?> 
                    <div class="input-group gap-2 flex-nowrap">
                        ...
                        <select id="column_employee_id" data-placeholder="<?php echo e(__('employee.select_employee')); ?>" name="column_employee_id"
    ...
    <script type="text/javascript" defer>
        ...
        const columns = [{
            ...
            },
            {
                ...
                title: "<?php echo e(__('report.lbl_booking_date')); ?>"
            },
            {
                data: 'id',
                name: 'id',
                title: "<?php echo e(__('report.lbl_inv_id')); ?>",
            },
            {
                data: 'employee_id',
                name: 'employee_id',
                title: "<?php echo e(__('report.lbl_staff')); ?>",
            },
            {
                data: 'total_service',
                name: 'total_service',
                title: "<?php echo e(__('report.lbl_tot_service')); ?>",
            },
            {
                data: 'total_service_amount',
                name: 'total_service_amount',
                title: "<?php echo e(__('report.lbl_tot_service_amt')); ?>",
            },
            {
                data: 'total_tax_amount',
                name: 'total_tax_amount',
                title: "<?php echo e(__('report.lbl_taxes')); ?>",
            },
            {
                data: 'total_tip_amount',
                name: 'total_tip_amount',
                title:  "<?php echo e(__('report.lbl_tips')); ?>",
            },
            {
                data: 'total_amount',
                name: 'total_amount',
                title:  "<?php echo e(__('report.lbl_tot_amt')); ?>",
            },
            {
                data: 'start_date_time',
                name: 'start_date_time',
        ...
        document.addEventListener('DOMContentLoaded', (event) => {
            initDatatable({
                url: '<?php echo e(route('backend.reports.overall-booking-report.index_data')); ?>',
                finalColumns,
                orderColumn: [[ 9, "desc" ]],
                advanceFilter: () => {
                    return {
...
<?php echo $__env->make('backend.layouts.app', ['isNoUISlider' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tayasmart/jospa.tayasmart.com/resources/views/backend/reports/overall-booking-report.blade.php ENDPATH**/ ?>