...
<?php $component->withAttributes([]); ?>
          <div>
          <?php if(auth()->user()->can('edit_app_banner') || auth()->user()->can('delete_app_banner')): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.quick-action','data' => ['url' => ''.e(route('backend.app_banners.bulk_action')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['url' => ''.e(route('backend.app_banners.bulk_action')).'']); ?>
              <div class="">
                <select name="action_type" class="form-control select2 col-12" id="quick-action-type" style="width:100%">
                    <option value=""><?php echo e(__('messages.no_action')); ?></option>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit_app_banner')): ?>
                    <option value="change-status"><?php echo e(__('messages.status')); ?></option>
                    <?php endif; ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete_app_banner')): ?>
...
<?php endif; ?>
            <?php endif; ?>
             ...
             <?php $__env->slot('toolbar', null, []); ?> 
              ...
              <?php if(Auth::user()->can('add_app_banner')): ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['target' => '#form-offcanvas','title' => '']); ?><?php echo e(__('messages.new')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
      ...
      <div data-render="app">
        <slider-form-offcanvas 
             ...
             create-title="<?php echo e(__('messages.new')); ?> <?php echo e(__($module_title)); ?>"
...
<script src="<?php echo e(mix('modules/slider/script.js')); ?>"></script>
...
<script type="text/javascript">
        ...
        { data: 'name', name: 'name', title: "<?php echo e(__('slider.lbl_name')); ?>",  width:'15%' },
        { data: 'link', name: 'link', title: "<?php echo e(__('slider.lbl_link')); ?>",  width:'15%' },
        { data: 'type', name: 'type', title: "<?php echo e(__('slider.lbl_type')); ?>",  width:'15%'},
        { data: 'link_id', name: 'link_id', title: "<?php echo e(__('slider.lbl_link_id')); ?>",  width:'15%'},
        { data: 'status', name: 'status', title: "<?php echo e(__('slider.lbl_status')); ?>", width:'15%'},
        {
            data: 'updated_at',
            name: 'updated_at',
      ...
      const actionColumn = [
            { data: 'action', name: 'action', orderable: false, searchable: false, title: "<?php echo e(__('slider.lbl_action')); ?>"}
        ]
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tayasmart/jospa.tayasmart.com/Modules/Slider/Resources/views/backend/sliders/index_datatable.blade.php ENDPATH**/ ?>