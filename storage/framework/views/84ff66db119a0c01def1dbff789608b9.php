...
<div style="position: fixed; top: 0; left: 0; width: 100%; background-color: #2e2e2e;height: 36px;color: #bc9a69; text-align: center; padding: 10px 0; z-index: 9999;font-size: 14px;font-family: 'Lama Sans', sans-serif !important;font-style: <?php echo e(app()->getLocale() == 'ar' ? 'italic !important' : 'normal !important'); ?>;font-weight: bold;line-height: 1.25rem;">
    <?php echo e(__('messagess.hero_banar')); ?>
                ...
                <div class="d-flex align-items-center gap-1">
                    <span class="rounded-circle p-2 d-flex align-items-center justify-content-center">
                        <svg data-v-49efcba9="" style="width: 16px" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="phone" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path class="" fill="white" d="M164.9 24.6c-7.7-18.6-28-28.5-47.4-23.2l-88 24C12.1 30.1 0 46 0 64C0 311.4 200.6 512 448 512c18 0 33.8-12.1 38.6-29.5l24-88c5.3-19.4-4.6-39.7-23.2-47.4l-96-40c-16.3-6.8-35.2-2.1-46.3 11.6L304.7 368C234.3 334.7 177.3 277.7 144 207.3L193.3 167c13.7-11.2 18.4-30 11.6-46.3l-40-96z"></path></svg>
                                  ...
                                  <a style="color: white;font-family: 'Lama Sans', sans-serif !important;font-style: <?php echo e(app()->getLocale() == 'ar' ? 'italic !important' : 'normal !important'); ?>;font-size: 14.4px;" href="tel:920012924">920012924</a>
                </div>
            </div>
        </div>
    </div>
</div>
<?php /**PATH /home/tayasmart/jospa.tayasmart.com/resources/views/components/frontend/navbar.blade.php ENDPATH**/ ?>