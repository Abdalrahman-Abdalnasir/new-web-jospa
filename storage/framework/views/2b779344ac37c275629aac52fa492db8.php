...
<?php if($status): ?>
    <div <?php echo e($attributes->merge(['class' => 'alert bg-soft-success'])); ?>>
        <?php echo e($status); ?>

    </div>
<?php endif; ?>
<?php /**PATH /home/tayasmart/jospa.tayasmart.com/resources/views/components/auth-session-status.blade.php ENDPATH**/ ?>