...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.quick-action','data' => ['url' => ''.e(route('backend.country.bulk_action')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['url' => ''.e(route('backend.country.bulk_action')).'']); ?>
                        <div class="">
...
<?php endif; ?>
    ...
    <div data-render="app">
        <form-offcanvas create-title="<?php echo e(__('messages.new')); ?> <?php echo e(__('country.singular_title')); ?>"
            edit-title="<?php echo e(__('messages.edit')); ?> <?php echo e(__('country.singular_title')); ?>">
        </form-offcanvas>
    </div>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tayasmart/jospa.tayasmart.com/Modules/World/Resources/views/backend/country/index_datatable.blade.php ENDPATH**/ ?>