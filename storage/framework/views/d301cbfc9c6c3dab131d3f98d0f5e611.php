<div class="d-flex gap-2 align-items-center">
    ...
    <a href="<?php echo e(route('backend.state.destroy', $data->id)); ?>" id="delete-<?php echo e($module_name); ?>-<?php echo e($data->id); ?>"
        ...
        data-confirm="<?php echo e(__('messages.are_you_sure?', ['module' => __('state.singular_title'), 'name' => $data->name])); ?>">
        <i class="fa-solid fa-trash"></i></a>

</div>
<?php /**PATH /home/tayasmart/jospa.tayasmart.com/Modules/World/Resources/views/backend/state/action_column.blade.php ENDPATH**/ ?>