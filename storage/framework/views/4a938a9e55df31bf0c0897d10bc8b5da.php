...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.quick-action','data' => ['url' => ''.e(route('backend.city.bulk_action')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['url' => ''.e(route('backend.city.bulk_action')).'']); ?>
                        <div class="">
...
<?php endif; ?>
    ...
    <div data-render="app">
        <city-form-offcanvas create-title="<?php echo e(__('messages.new')); ?> <?php echo e(__('city.singular_title')); ?>"
            edit-title="<?php echo e(__('messages.edit')); ?> <?php echo e(__('city.singular_title')); ?>">
        </city-form-offcanvas>
    </div>
    ...
    <script type="text/javascript" defer>
        const columns = [{
            ...
            },
            {
                data: 'state_id',
                name: 'state_id',
                title: "<?php echo e(__('state.singule_title')); ?>"
            },
            {
                data: 'country_id',
                name: 'country_id',
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tayasmart/jospa.tayasmart.com/Modules/World/Resources/views/backend/city/index_datatable.blade.php ENDPATH**/ ?>