    ...
    <script type="text/javascript" defer>
        ...
        const columns = [{
            ...
            },
            {
                data: 'total_booking',
                name: 'total_booking',
                title: "<?php echo e(__('report.lbl_no_booking')); ?>",
                width: '10%'
            },
            {
                data: 'total_service',
            ...
            },
            {
                ...
                title: "<?php echo e(__('report.lbl_service_amount')); ?>",
            },
            {
                data: 'total_tax_amount',
                name: 'total_tax_amount',
                title: "<?php echo e(__('report.lbl_tax_amt')); ?>",
            },
            {
            ...
            },
            {
                data: 'total_amount',
                name: 'total_amount',
                title: "<?php echo e(__('report.lbl_final_amt')); ?>",
            },
        ]
        ...
        document.addEventListener('DOMContentLoaded', (event) => {
            initDatatable({
                url: '<?php echo e(route('backend.reports.daily-booking-report.index_data')); ?>',
                finalColumns,
                orderColumn: [[ 1, "desc" ]],
                advanceFilter: () => {
                    return {
...
<?php echo $__env->make('backend.layouts.app', ['isNoUISlider' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tayasmart/jospa.tayasmart.com/resources/views/backend/reports/daily-booking-report.blade.php ENDPATH**/ ?>