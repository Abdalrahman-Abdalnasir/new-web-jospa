...
<img src="<?php echo e(asset('images/gift.webp')); ?>" alt="<?php echo e(__('messagess.background_alt')); ?>"
...
<div class="position-relative d-flex flex-column align-items-center justify-content-center text-center px-2 px-md-0"
    ...
    <img src="<?php echo e(asset('images/frontend/gift-card-1.svg')); ?>" alt="<?php echo e(__('messagess.card_alt')); ?>"
...
<div style="margin-top: -95px !important;">
    <a href="<?php echo e(route('gift.page')); ?>"
       ...
       style="z-index: 9999999999999999999999; position: relative; background-color: var(--primary-color); border-right: 3px solid white; border-left: 3px solid white; border-radius: 30px;width: 20%;padding: 15px 50px;">
        <span class="text-center" style="font-size: 22.4px;white-space: nowrap;"><?php echo e(__('messagess.choose_gift_now')); ?></span>
...
<?php /**PATH /home/tayasmart/jospa.tayasmart.com/resources/views/components/frontend/gift-section.blade.php ENDPATH**/ ?>