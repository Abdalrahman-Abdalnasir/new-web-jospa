...
<body class="bg-white">
    ...
    <div class="position-relative" style="height: 200px;">
        <img src="<?php echo e(asset('images/frontend/slider1.webp')); ?>" alt="Contact Hero" class="w-100 " style="object-fit: cover;height: 145%;">
    ...
    <main>
        ...
        <?php echo $__env->make('components.frontend.contact-info', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </main>
...
<?php /**PATH /home/tayasmart/jospa.tayasmart.com/Modules/rontend/Resources/views/contact.blade.php ENDPATH**/ ?>