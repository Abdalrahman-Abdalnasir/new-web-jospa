    ...
    <script type="text/javascript" defer>
        ...
        const columns = [{
            ...
            },
            {
                data: 'payment_date',
                name: 'payment_date',
                title: "<?php echo e(__('report.lbl_payment_date')); ?>",
            },
            {
                data: 'first_name',
                name: 'first_name',
            ...
            },
            {
                ...
                title: "<?php echo e(__('report.lbl_commission_amt')); ?>",
            },
            {
                data: 'tip_amount',
                name: 'tip_amount',
                title: "<?php echo e(__('report.lbl_tips_amt')); ?>",
            },
            {
                data: 'payment_type',
                name: 'payment_type',
                title: "<?php echo e(__('report.lbl_payment_type')); ?>",
                orderable: false,
                searchable: false
            },
            {
                data: 'total_pay',
                name: 'total_pay',
                title: "<?php echo e(__('report.lbl_tot_pay')); ?>",
                searchable: false
            },
            {
                data: 'updated_at',
        ...
        document.addEventListener('DOMContentLoaded', (event) => {
            initDatatable({
                url: '<?php echo e(route('backend.reports.payout-report.index_data')); ?>',
                finalColumns,
                orderColumn: [[ 7, "desc" ]],
                advanceFilter: () => {
                    return {
...
<?php echo $__env->make('backend.layouts.app', ['isNoUISlider' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tayasmart/jospa.tayasmart.com/resources/views/backend/reports/payout-report.blade.php ENDPATH**/ ?>