    ...
    <script type="text/javascript" defer>
        ...
        const columns = [{
            ...
            },
            {
                data: 'total_services',
                name: 'total_services',
                title: "<?php echo e(__('report.lbl_no_services')); ?>",
            },
            {
            ...
            },
            {
                ...
                title: "<?php echo e(__('report.lbl_commissions_earn')); ?>"
            },
            {
                data: 'total_tip_earn',
                name: 'total_tip_earn',
                title: "<?php echo e(__('report.lbl_tips_earn')); ?>"
            },
            {
                data: 'total_earning',
                name: 'total_earning',
                title: "<?php echo e(__('report.lbl_total_earning')); ?>"
            },
            {
                data: 'updated_at',
                name: 'updated_at',
                title: "<?php echo e(__('report.lbl_updated_at')); ?>",
                visible: false,
            },
        ]
        ...
        document.addEventListener('DOMContentLoaded', (event) => {
            initDatatable({
                url: '<?php echo e(route('backend.reports.staff-report.index_data')); ?>',
                finalColumns,
                orderColumn: [[ 7, "desc" ]],
                advanceFilter: () => {
                    return {
...
<?php echo $__env->make('backend.layouts.app', ['isNoUISlider' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tayasmart/jospa.tayasmart.com/resources/views/backend/reports/staff-report.blade.php ENDPATH**/ ?>