...
<?php endif; ?>
        ...
        <form method="POST" action="<?php echo e(route('signin.verify')); ?>">
            <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['id' => 'email','type' => 'email','name' => 'email','value' => old('email'),'placeholder' => 'Enter Email','required' => true,'autofocus' => true,'pattern' => '[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$','title' => 'Please enter a valid email address.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'email','type' => 'email','name' => 'email','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('email')),'placeholder' => 'Enter Email','required' => true,'autofocus' => true,'pattern' => '[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$','title' => 'Please enter a valid email address.']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                ...
                <?php if (isset($component)) { $__componentOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['id' => 'password','type' => 'password','name' => 'password','placeholder' => 'Enter  password','required' => true,'minlength' => '8','maxlength' => '12','autocomplete' => 'current-password','title' => 'Password must be between 8 and 12 characters.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'password','type' => 'password','name' => 'password','placeholder' => 'Enter  password','required' => true,'minlength' => '8','maxlength' => '12','autocomplete' => 'current-password','title' => 'Password must be between 8 and 12 characters.']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1)): ?>
<?php $attributes = $__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1; ?>
...
<?php endif; ?>
            ...
            <div class="mt-4">
                <label for="remember_me" class="d-inline-flex">
                    ...
                    <span class="ms-2"><?php echo e(__('Remember me')); ?></span>
                </label>
            </div>
...
<?php endif; ?>
         ...
         <?php $__env->slot('extra', null, []); ?> 
                <p class="text-center text-gray-600 mt-4">
                    Do not have an account? <a href="<?php echo e(route('signup')); ?>"
...
<?php endif; ?>
<?php /**PATH /home/tayasmart/jospa.tayasmart.com/resources/views/components/frontend/auth/signin.blade.php ENDPATH**/ ?>