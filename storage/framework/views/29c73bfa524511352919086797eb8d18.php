...
<?php $component->withAttributes([]); ?>
      <div class="d-flex flex-wrap gap-3">
        <?php if(auth()->user()->can('edit_customer') || auth()->user()->can('delete_customer')): ?>
...
<?php endif; ?>
       ...
       <?php $__env->slot('toolbar', null, []); ?> 
        ...
        <?php if(Auth::user()->can('add_customer')): ?>
...
<div data-render="app">
  <customer-offcanvas default-image="<?php echo e(default_user_avatar()); ?>" create-title="<?php echo e(__('messages.new')); ?> <?php echo e(__('customer.singular_title')); ?>"
    edit-title="<?php echo e(__('messages.edit')); ?> <?php echo e(__('customer.singular_title')); ?>" :customefield="<?php echo e(json_encode($customefield)); ?>">
  </customer-offcanvas>
...
<script src="<?php echo e(mix('modules/customer/script.js')); ?>"></script>
...
<script type="text/javascript" defer>
  const columns = [{
      ...
      //   orderable: false,
      //   searchable: false,
      //   title: "<?php echo e(__('customer.lbl_profile_image')); ?>"
      // },

    {
      ...
      //   data: 'first_name',
      //   name: 'first_name',
      //   title: "<?php echo e(__('customer.lbl_first_name')); ?>"
      // },
      // {
      //   data: 'last_name',
      //   name: 'last_name',
      //   title: "<?php echo e(__('customer.lbl_last_name')); ?>"
      // },
      
      {
        data: 'gender',
        name: 'gender',
        title: "<?php echo e(__('customer.lbl_gender')); ?>"
      },
      // {
      //   data: 'email',
      //   name: 'email',
      //   title: "<?php echo e(__('customer.lbl_Email')); ?>"
      // },
      // {
      //   data: 'image',
      //   name: 'image',
      ...
      // },
      {
        ...
        orderable: false,
        searchable: true,
        title: "<?php echo e(__('customer.lbl_verification_status')); ?>"
      },
      {
        data: 'wallet_balance',
        name: 'wallet_balance',
      ...
      //   orderable: false,
      //   searchable: true,
      //   title: "<?php echo e(__('customer.lbl_blocked')); ?>"
      // },
      {
        data: 'status',
        name: 'status',
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tayasmart/jospa.tayasmart.com/Modules/Customer/Resources/views/backend/customers/index.blade.php ENDPATH**/ ?>