        ...
        <div class="container">
            <div class="hero-content">
                <div class="hero-title">
                    ...
                    <h1><?php echo e($package['name'][app()->getLocale()] ?? ''); ?></h1>
                    <svg class="sparkle" width="32" height="32" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M12 0l1.5 5.5L19 6l-5.5 1.5L12 13l-1.5-5.5L5 6l5.5-1.5L12 0z"/>
                    </svg>
                </div>
...
<p class="original-price"><?php echo e(__('messagess.original_price', ['price' => $totalServicePrice])); ?></p>
<p class="discount-price"><?php echo e(__('messagess.discounted_price', ['price' => $totalService])); ?></p>
                </div>
...
<section class="services-section">
    <div class="container">
       <h2><?php echo e(__('messagess.prices_and_services')); ?></h2>
...
<div class="total-price mt-4">
    <h4><?php echo e(__('messagess.total_price', ['price' => $totalService])); ?></h4>
</div>
...
<h2><?php echo e(__('messagess.book_package')); ?></h2>
                </div>
                <div class="card-content">
                    <form id="bookingForm">
                        <div class="form-field">
<label class="form-label"><?php echo e(__('messagess.select_date')); ?></label>
                            <input type="date" id="dateInput" class="form-input" required>
                        </div>

                        <div class="form-field">
<label class="form-label"><?php echo e(__('messagess.select_time')); ?></label>
...
<?php /**PATH /home/tayasmart/jospa.tayasmart.com/resources/views/home/details.blade.php ENDPATH**/ ?>