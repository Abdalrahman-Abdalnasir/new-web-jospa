...
<script type="text/javascript">
    const finalColumns = [ 
        ...
        },
        {
            ...
            title: "<?php echo e(__('messages.messages')); ?>",
            width: '15%',
        },
        {
            data: 'amount',
    ...
    document.addEventListener('DOMContentLoaded', (event) => {
        initDatatable({
            url: '<?php echo e(route("wallet.history-data", ["id" => $user_id])); ?>',
            finalColumns,
            orderColumn: [[ 4, "desc" ]],
        })
    })
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tayasmart/jospa.tayasmart.com/Modules/Wallet/Resources/views/wallet_history/index_datatable.blade.php ENDPATH**/ ?>