...
<head>
    ...
    <title><?php echo e(__('messagess.success_status')); ?></title>
...
<body>
    <div class="capture-container">
        ...
        <div class="capture-title"><?php echo e(__('messagess.success_status')); ?></div>
        <button class="back-btn" onclick="window.location.href='/'"><?php echo e(__('messagess.back_to_home')); ?></button>
    </div>
</body>
</html><?php /**PATH /home/tayasmart/jospa.tayasmart.com/resources/views/components/frontend/status/CAPTURED.blade.php ENDPATH**/ ?>